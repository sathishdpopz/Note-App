package com.sathish.notesapp.Adapters;
...
import com.sathish.notesapp.NotesClickListener;
import com.sathish.notesapp.R;
...
public class NotesListAdapter extends RecyclerView.Adapter<NotesViewHolder>{
    ...
    Context context;
    List<Notes> list;
    NotesClickListener noteClickListener;

    public NotesListAdapter(Context context, List<Notes> list, NotesClickListener noteClickListener) {
